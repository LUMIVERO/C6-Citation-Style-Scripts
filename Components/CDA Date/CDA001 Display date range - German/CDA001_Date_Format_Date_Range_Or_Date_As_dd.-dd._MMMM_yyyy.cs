...
namespace SwissAcademic.Citavi.Citations
{
		...
		IComponentPartFilter
	{
		...
		public IEnumerable<ITextUnit> GetTextUnits(ComponentPart componentPart, Template template, Citation citation, out bool handled)
		{
			...
			string outputFormatSingleDateBibliography = "{1:yyyy}{0}, {3:%d}. {2:MMMM}";																//e.g. 2013a, 6. Januar

			//DATE RANGE - output format templates
			//same year, same month
			string outputFormatDateRangeSameYearSameMonthPlaceholder = "{1:yyyy}{0}";																	//e.g. 2013a
			string outputFormatDateRangeSameYearSameMonthBibliography = "{1:yyyy}{0}, {3:%d}. - {6:%d}. {2:MMMM}";										//e.g. 2013a, 6. - 9. Januar

			//same year, different month
			string outputFormatDateRangeSameYearDifferentMonthPlaceholder = "{1:yyyy}{0}";																//e.g. 2013a
			string outputFormatDateRangeSameYearDifferentMonthBibliography = "{1:yyyy}{0}, {3:%d}. {2:MMMM} - {6:%d}. {5:MMMM}";						//e.g. 2013a, 28. September - 3. Oktober

			//different years
			string outputFormatDateRangeDifferentYearsPlaceholder = "{1:yyyy}/{4:yyyy}{0}";																//e.g. 2013/2014a
			string outputFormatDateRangeDifferentYearsBibliography = "{1:yyyy}/{4:yyyy}{0}, {3:%d}. {2:MMMM} {1:yyyy} - {6:%d}. {5:MMMM} {4:yyyy}";		//e.g. 2013/2014a, 29. Dezember 2013 - 4. Januar 2014
		...
		private bool ContainsND(string dateString)
		{
			...
			string ndRegexPattern = @"(?<oJ>o\.{0,1} *J\.{0,1} *)";
		...
		{
			string ndRegexPattern = @"(?<oJ>o\.{0,1} *J\.{0,1} *)(?<identifyingLetter>" + identifyingLetter + @")$";
			string ndMatch = "";
			var index = -1;
			bool found = false;
