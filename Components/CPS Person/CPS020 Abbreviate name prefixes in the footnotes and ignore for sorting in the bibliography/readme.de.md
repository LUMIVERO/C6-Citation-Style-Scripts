...
In Ihrem Citavi-Projekt erfassen Sie unter **Listen** > **Personen und Institutionen** den Namen mit dem Präfix im Feld "**Name**", z. B. `v. Münch`. Im Feld **Sortieren nach** geben Sie den Namen so ein, wie er im Literaturverzeichnis für die Sortierung berücksichtigt werden soll (z. B. `Münch, Ingo von`).

<img src="https://github.com/Citavi/C6-Citation-Style-Scripts/blob/master/Components/CPS%20Person/CPS020%20Abbreviate%20name%20prefixes%20in%20the%20footnotes%20and%20ignore%20for%20sorting%20in%20the%20bibliography/Namenspr%C3%A4fix%20%2B%20Sortieren%20nach%20-%20v.%20M%C3%BCnch.png" width="600">
