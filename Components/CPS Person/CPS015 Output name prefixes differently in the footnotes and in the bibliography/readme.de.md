...
Unter **Listen** > **Personen und Institutionen** erfassen Sie den Namen mit dem (ggf. abgekürzten) Präfix im Feld "**Name**", z.B. `von Münch`. Im Feld **Sortieren nach** geben Sie den Namen so ein, wie er im Literaturverzeichnis erscheinen soll (z.B. `Münch, Ingo von`)
