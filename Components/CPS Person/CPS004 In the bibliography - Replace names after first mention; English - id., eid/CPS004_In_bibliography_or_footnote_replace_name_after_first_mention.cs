//C6#CPS004
//C5#43112
//Description: In bibliography or footnote replace name after first mention
//Version: 1.16  
#region Version History
//Version: 1.16  Adds options for showing group prefix and/or group suffix (e.g.: "idem (Ed.)")
...
//				Configurable output for missing author(s), e.g. DE: "o.A."
//				Increased Version number to 1.15 for compatibility with numbering of the German Component "ders./dies."
...
namespace SwissAcademic.Citavi.Citations
{
		...
		IComponentPartFilter
	{
		...
		{
			//if the following is set to true a placeholder citation's output will not show id./ead. etc. although this would normally be the case
			...
			//false: 	(Mueller 2010, S. 10; id. 2011, S. 12 f; id. 2012, S. 17)
			...
			var missingPersonsInfo = "";												//can be set to e.g. "N.N."/"nomen nescio"; leave empty otherwise
